    ...
    <Modal open={connection === ''}>
      ...
      >
        <OneTimePopup
          title="PolarisLLM"
          onGetStarted={() => {
            // Set a default connection to bypass login and show welcome screen
            setServer('welcome');
          }}
        >
          <div
          ...
          >
            ...
            <p style={{ margin: '4px 0', fontSize: '14px' }}>
              🎯 One-Command Deployment • 🌐 Instant Public APIs • ⚡
            ...
            >
              &ldquo;The Docker for Large Language Models&rdquo;
            </p>
          </div>
        </OneTimePopup>
        <Tabs
        ...
        >
          Provide connection information:
            ...
            <Alert variant="plain">
              ...
              >
                <a
                  href="https://polarisllm.ai/docs/install/install-on-cloud"
                  target="_blank"
                  rel="noreferrer"
                >
                  Follow these instructions
                </a>{' '}
                to install the PolarisLLM Engine on a remote computer. Once you
                have completed those steps, enter the server URL and port below.
              </Typography>
            </Alert>
            <form
